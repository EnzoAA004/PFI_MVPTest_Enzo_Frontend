...
assertContains("src/App.tsx", app, /No se pudo cargar la lista de estudios/, "backend 500 debe mostrar error humano");
assertNotContains("src/App.tsx", app, /setStudiesError\(`[^`]*\$\{detail\}/, "el error visible no debe filtrar detalle backend");
